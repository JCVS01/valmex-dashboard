...
<header class="topbar">
  <div class="brand">
    ...
    <!-- Logo clickeable → Presentación -->
    <button class="logo-btn" onclick="showPage('presentacion')" title="Ver presentación comercial">
      <svg class="logo-svg" viewBox="0 0 240 56" fill="none" xmlns="http://www.w3.org/2000/svg">
        <!-- M estilizada -->
        <polygon points="0,50 5,50 20,12 15,12" fill="white"/>
        <polygon points="44,50 49,50 34,12 29,12" fill="white"/>
        <polygon points="15,12 20,12 30,34 25,34" fill="white"/>
        <polygon points="29,12 34,12 24,34 19,34" fill="white"/>
        <!-- Vértice teal -->
        <polygon points="19,34 30,34 24.5,44" fill="#41BBC9"/>
        <!-- Línea divisoria -->
        <rect x="58" y="8" width="3" height="40" rx="1.5" fill="#41BBC9"/>
        <!-- VALORES -->
        <text x="70" y="28" font-family="Montserrat,sans-serif" font-weight="700" font-size="17" letter-spacing="2" fill="white">VALORES</text>
        <!-- MEXICANOS -->
        <text x="70" y="48" font-family="Montserrat,sans-serif" font-weight="700" font-size="17" letter-spacing="2" fill="white">MEXICANOS</text>
      </svg>
    </button>

    <!-- Nav -->
    <nav class="nav">
      <button class="nav-tab" onclick="showPage('configuracion',this)">Configuración</button>
    ...
    <div class="header-right">
      ...
      <span class="advisor-name">José Carlos</span>
    </div>
  </div>
</header>
  ...
  <div id="page-presentacion" class="page active">
    <div class="pres-card">
      <div class="pres-header">
        <h2>Presentación</h2>
        <a href="PRESENTACIO_N_COMERCIAL.pdf"
      ...
      <div class="pres-iframe-wrap">
        <iframe
          src="PRESENTACIO_N_COMERCIAL.pdf#toolbar=0&navpanes=0&scrollbar=0&view=FitH"
          title="Presentación Comercial Valmex">
        </iframe>
      </div>
    </div>
  </div>
      ...
      <div class="propuesta-dashboard" id="propuesta-dashboard">
        ...
        <div class="board">
          ...
          <div class="card hoy">
            ...
            <div class="body prop-rh-body">
              <div class="rh-grid">
                ...
                <div class="rh-block"><span class="rh-pill">RV México</span><span class="rh-val neg">−0.12%</span></div>
          ...
          <div class="card linea">
            <header>Rendimientos Mensuales — Perfiles a través del Tiempo</header>
          ...
          <div class="card pie2">
            <header>Exposición Geográfica RV</header>
            <div class="body" style="padding:6px;height:100%;"><canvas id="chart-geo"></canvas></div>
          </div>
          <div class="card pie3">
            <header>Exposición Sectorial RV</header>
  ...
  <div id="page-configuracion" class="page">
    <div class="config-grid">
      <div class="cfg-card">
        ...
        <div class="cfg-body">
          <div class="fg"><label>Nombre completo</label><input type="text" placeholder="Ej. María García López"></div>
      ...
      <div class="cfg-card">
        <div class="cfg-header"><h3>Parámetros del Portafolio</h3></div>
        <div class="cfg-body">
          ...
          <div class="fg"><label>Horizonte de inversión</label>
            <select><option>1 año</option><option selected>3 años</option><option>5 años</option><option>10+ años</option></select>
          </div>
          <div class="fg"><label>Moneda de reporte</label>
            <select><option selected>MXN</option><option>USD</option></select>
          </div>
          <button class="btn-primary">Aplicar parámetros</button>
        </div>
      </div>
    </div>
  </div>
  ...
  <div id="page-elite" class="page">
    <div class="elite-hero">
      ...
      <div class="elite-text">
        <h2>VALMEX ELITE</h2>
        <p>Acceso exclusivo a estrategias de inversión de alto impacto, análisis cuantitativo avanzado y reportería personalizada para patrimonios significativos.</p>
      </div>
    </div>
    <div class="elite-features">
      <div class="ef-card"><div class="ef-icon">📊</div><h4>Análisis Cuantitativo</h4><p>Modelos propietarios con datos de Morningstar y Bloomberg para optimización de portafolios.</p></div>
      <div class="ef-card"><div class="ef-icon">🌐</div><h4>Acceso Global</h4><p>Más de 10,000 instrumentos en 45 mercados internacionales.</p></div>
      <div class="ef-card"><div class="ef-icon">📄</div><h4>Reportería Premium</h4><p>Presentaciones ejecutivas automatizadas con tu branding y datos en tiempo real.</p></div>
    </div>
  </div>
...
charts.geo    = makeDoughnut('chart-geo',    ['México','EUA','Europa','Asia','Latam'],[28,35,18,11,8]);
charts.sector = makeDoughnut('chart-sector', ['Financiero','Tecnología','Consumo','Salud','Industrial','Energía'],[22,25,18,14,12,9]);
